...
class SetupTheme
{
	...
	public static function nu__register_sidebars() {
		...
		register_sidebar(
			array(
				...
				'after_widget'  => '<i class="fa-regular fa-xmark"></i></div>',
				'before_title'  => '<p class="widget-title">',
				'after_title'   => '</p>',
			)
		);
		register_sidebar(
			array(
				...
				'after_widget'  => '<i class="fa-regular fa-xmark"></i></div></div>',
				'before_title'  => '<p class="widget-title">',
				'after_title'   => '</p>',
			)
		);
	...
	public static function _do_enqueueStyles(){
		...
		// register fonts
		wp_enqueue_style( 'nu-site-fonts', get_template_directory_uri() . '/__precomp/build/css/fonts.css' );
