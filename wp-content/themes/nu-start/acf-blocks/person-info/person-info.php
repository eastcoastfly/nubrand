...
$person_info = sprintf(
	...
	!empty($person_metadata['email']) ? '<p class="email has-inline-icon"><a href="mailto:'.$person_metadata['email'].'"><i class="fa-solid fa-envelope"></i>'.$person_metadata['email'].'</a></p>' : '',
	!empty($person_metadata['phone_number']) ? '<p class="phone-number has-inline-icon"><a href="tel:'.$person_metadata['phone_number'].'"><i class="fa-solid fa-phone"></i>'.$person_metadata['phone_number'].'</a></p>' : '',
);
