...
const registerBlocks = () => {
  [_src_block_library_accordion__WEBPACK_IMPORTED_MODULE_1__, _src_block_library_accordion_item__WEBPACK_IMPORTED_MODULE_2__].forEach(registerBlock);
};
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":1,"name":"nu-blocks/accordion","title":"Accordion","category":"nu-blocks","icon":"dashicons-star-empty","description":"Organize content within collapsable accordion items.","keywords":["accordion","nu"],"supports":{"html":true,"anchor":true,"align":["left","center","right","wide","full"]},"attributes":{"count":{"type":"number","default":"1"}},"styles":[],"textdomain":"nublocks","editorScript":"file:../../../build/index.js","editorStyle":"file:../../../build/index.css","style":"file:../../../build/style-index.css"}');
